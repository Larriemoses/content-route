...
create table linkedin_connections (id uuid primary key default gen_random_uuid(), provider text unique not null, member_sub text, access_token text not null, expires_at timestamptz not null, updated_at timestamptz not null default now());
